...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container">
        <div class="aboutme">
            ...
            <h1 style="text-align: right;">My Story
                <br />
            ...
            <p>
                ...
                I love creating those awesome <strong>responsive websites</strong> meticulously designed for each client.
            </p>
            <%--<p class="right">
            ...
            <p>
                ...
                Keeping track of your visitors can yeild vital information about your perspective clients, that why I rely on <strong>Google Analytics</strong> & <strong>Heap Analytics</strong> to better 
