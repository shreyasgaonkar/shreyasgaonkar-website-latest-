        ...
        <div class="container">
            ...
            <div class="inspiratons">
                <p>
                 ...
                 <br /><br /> Below are few of the persons around the globe in no particular order, whose work I really admire.
                </p>
                <hr />
            </div>
            ...
            <div class="row center heros">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="well" style="padding: 20px 30px;">
                        <div class="row img-border">
                            <img src="images/travis.jpg" title="Travis Neilson" alt="Travis Neilson"/>
                        </div>
                        <h3><a href="#/" class="a-no-underline" >Travis Neilson </a><br />
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="well" style="padding: 20px 30px;">
                        <div class="row img-border">
                            <img src="images/brad.jpg" alt="Brad Hussey" title="Brad Hussey"/>
                        </div>
                        <h3><a href="#/" class="a-no-underline">Brad Hussey</a><br />
                            <small>Web Designer | YouTuber</small>
                        </h3>
                        <p>
                            ahdajkdhaakjhdjh
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="well" style="padding: 20px 30px;">
                        <div class="row img-border">
                            <img src="images/aaron.jpg" alt="Aaron Nace" title="Aaron Nace"/>
                        </div>
                        <h3><a href="#/" class="a-no-underline">Aaron Nace</a><br />
                            <small>Photographer | YouTuber</small>
                        </h3>
                        <p>
                            ahdajkdhaakjhdjh
                        </p>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="well" style="padding: 20px 30px;">
                        <div class="row img-border">
                            <img src="images/gavin.jpg" alt="Gavin Hoey" title="Gavin Hoey"/>
                        </div>
                        <h3><a href="#/" class="a-no-underline">Brad Hussey</a><br />
                            <small>Photographer | YouTuber</small>
                        </h3>
