            ...
            <div class="container" id="portfolio">
                ...
                <div class="grid-items-lines" style="cursor: pointer;">
                    ...
                    <a href="http://www.motelife.co/" class="grid-item grid-item-big" target="_blank">
                        ...
                        <h1>Lead Web Developer and UI/UX Designer</h1>
                        <p><i>May 2015 - August 2015</i></p>
                        <p>CollegeLife LLC</p>
                    </a>
                    ...
                    <a href="javascript:void(0)" class="grid-item">
                        ...
                        <p><i>July 2015 - September 2015</i></p>
                        <p>AML Health Coach</p>
                    </a>
                    ...
                    <a href="http://random.shreyasg.com/" target="_blank" class="grid-item">
                        <img src="images/websites/SG.png" alt="ChemEnviroTech" />
                    ...
                    <a href="javascript:void(0)" class="grid-item">
                     ...
                     <a href="http://racecar.shreyasg.com/" target="_blank" class="grid-item">
                        <img src="images/websites/SG.png" alt="ChemEnviroTech" />
                        <h1>Racercar using JQuery</h1>
                         <br />
                        <%--<p><i>July 2015</i></p>--%>
